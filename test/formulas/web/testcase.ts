...
export default {
    ...
    FILTERXML: {
        'FILTERXML("<root><a>1</a></root>", "//a")': FormulaError.NOT_IMPLEMENTED('FILTERXML'), // Not implemented, throws NOT_IMPLEMENTED error
    },
    WEBSERVICE: {
        // test error handling for invalid URL (fetch exists in Node.js environment)
        'WEBSERVICE("invalid-url")': FormulaError.ERROR("WEBSERVICE failed"),
