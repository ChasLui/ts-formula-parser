...
module.exports = {
    ...
    DATEVALUE: {
        ...
        // all formats
        // Using 1900 as default year for dates without year specification
        'DATEVALUE("12/3/2014")': 41976,
        'DATEVALUE("Wednesday, December 3, 2014")': 41976,
        'DATEVALUE("2014-12-3")': 41976,
        'DATEVALUE("12/3")': 338, // defaults to 1900
        'DATEVALUE("12/3/14")': 41976,
        'DATEVALUE("12/03/14")': 41976,
        'DATEVALUE("3-Dec")': 338, // defaults to 1900
        'DATEVALUE("3-Dec-14")': 41976,
        'DATEVALUE("03-Dec-14")': 41976,
        'DATEVALUE("Dec-3")': 338, // defaults to 1900
        'DATEVALUE("December-3")': 338, // defaults to 1900
        ...
        'DATEVALUE("Dec-3 11:11")': 338, // defaults to 1900
