...
const DistributionFunctions = {
    'BETA.DIST': (x: any, alpha: any, beta: any, cumulative: any, a: any, b: any): number => {
    ...
    'BETA.INV': (probability: any, alpha: any, beta: any, a: any, b: any): number => {
    ...
    'BINOM.DIST': (numberS: any, trials: any, probabilityS: any, cumulative: any): number => {
    ...
    'CHISQ.DIST': (x: any, degFreedom: any, cumulative: any): number => {
        x = H.accept(x, Types.NUMBER);
    ...
    'CHISQ.INV': (probability: any, degFreedom: any): number => {
        probability = H.accept(probability, Types.NUMBER);
        degFreedom = H.accept(degFreedom, Types.NUMBER);
        degFreedom = Math.trunc(degFreedom);
    ...
    'CHISQ.INV.RT': (probability: any, degFreedom: any): number => {
        probability = H.accept(probability, Types.NUMBER);
        degFreedom = H.accept(degFreedom, Types.NUMBER);
        degFreedom = Math.trunc(degFreedom);
        if (probability < 0 || probability > 1 || degFreedom < 1 || degFreedom > 10 ** 10)
    ...
    CORREL: (array1: any, array2: any): number => {
        ...
        const filterArr1: number[] = [], filterArr2: number[] = [];
    ...
    'COVARIANCE.S': (array1: any, array2: any): number => {
        array1 = H.accept(array1, Types.ARRAY, undefined, true, true);
        array2 = H.accept(array2, Types.ARRAY, undefined, true, true);
        if (array1.length !== array2.length)
            throw FormulaError.NA;
    ...
    'EXPON.DIST': (x: any, lambda: any, cumulative: any): number => {
        x = H.accept(x, Types.NUMBER);
    ...
    'F.DIST': (x: any, d1: any, d2: any, cumulative: any): number => {
        x = H.accept(x, Types.NUMBER);
    ...
    'F.INV': (probability: any, d1: any, d2: any): number => {
        // David
        probability = H.accept(probability, Types.NUMBER);
        d1 = H.accept(d1, Types.NUMBER);
        d2 = H.accept(d2, Types.NUMBER);
    ...
    'F.INV.RT': (probability: any, d1: any, d2: any): number => {
        // David
        probability = H.accept(probability, Types.NUMBER);
        d1 = H.accept(d1, Types.NUMBER);
        d2 = H.accept(d2, Types.NUMBER);
    ...
    FORECAST: (x: any, knownYs: any, knownXs: any): number => {
        ...
        // filter out values that are not number
        const filteredY: number[] = [], filteredX: number[] = [];
        let xAllEqual = true;
    ...
    'FORECAST.LINEAR': (...params: any[]): number => {
        return DistributionFunctions.FORECAST(...(params as [any, any, any]));
    },
    ...
    FREQUENCY: (dataArray: any, binsArray: any): any[][] => {
        ...
        const binsArrayFiltered: number[] = [];
    ...
    'GAMMA.DIST': (x: any, alpha: any, beta: any, cumulative: any): number => {
        // David
    ...
    'GAMMA.INV': (probability: any, alpha: any, beta: any): number => {
        // David
    ...
    'LOGNORM.DIST': (x: any, mean: any, standard_dev: any, cumulative: any): number => {
    ...
    'LOGNORM.INV': (probability: any, mean: any, standard_dev: any): number => {
    ...
    'NEGBINOM.DIST': (number_f: any, number_s: any, probability_s: any, cumulative: any): number => {
    ...
    'NORM.DIST': (x: any, mean: any, standard_dev: any, cumulative: any): number => {
    ...
    'NORM.INV': (probability: any, mean: any, standard_dev: any): number => {
    ...
    'NORM.S.DIST': (z: any, cumulative: any): number => {
    ...
    'NORM.S.INV': (probability: any): number => {
    ...
    'POISSON.DIST': (x: any, mean: any, cumulative: any): number => {
    ...
    'T.DIST': (x: any, deg_freedom: any, cumulative: any): number => {
    ...
    'T.INV': (probability: any, deg_freedom: any): number => {
