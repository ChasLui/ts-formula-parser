...
import {FormulaHelpers, Types, Factorials, Criteria, type TypeValue} from '../helpers';
...
/**
 * Calculate double factorial of a number
 * @param n - Number to calculate double factorial for
 * @returns Double factorial result
 */
...
/**
 * Type definition for mathematical functions
 */
interface MathFunctionCollection {
    ABS(number: ExcelValue): FunctionResult;
    AGGREGATE(functionNum: ExcelValue, options: ExcelValue, ref1: ExcelValue, ...refs: ExcelValue[]): FunctionResult;
    ARABIC(text: ExcelValue): FunctionResult;
    BASE(number: ExcelValue, radix: ExcelValue, minLength?: ExcelValue): FunctionResult;
    CEILING(number: ExcelValue, significance: ExcelValue): FunctionResult;
    'CEILING.MATH'(number: ExcelValue, significance?: ExcelValue, mode?: ExcelValue): FunctionResult;
    'CEILING.PRECISE'(number: ExcelValue, significance?: ExcelValue): FunctionResult;
    COMBIN(number: ExcelValue, numberChosen: ExcelValue): FunctionResult;
    COMBINA(number: ExcelValue, numberChosen: ExcelValue): FunctionResult;
    DECIMAL(text: ExcelValue, radix: ExcelValue): FunctionResult;
    DEGREES(angle: ExcelValue): FunctionResult;
    EVEN(number: ExcelValue): FunctionResult;
    EXP(number: ExcelValue): FunctionResult;
    FACT(number: ExcelValue): FunctionResult;
    FACTDOUBLE(number: ExcelValue): FunctionResult;
    FLOOR(number: ExcelValue, significance: ExcelValue): FunctionResult;
    'FLOOR.MATH'(number: ExcelValue, significance?: ExcelValue, mode?: ExcelValue): FunctionResult;
    'FLOOR.PRECISE'(number: ExcelValue, significance?: ExcelValue): FunctionResult;
    GCD(...numbers: ExcelValue[]): FunctionResult;
    INT(number: ExcelValue): FunctionResult;
    'ISO.CEILING'(...params: ExcelValue[]): FunctionResult;
    LCM(...numbers: ExcelValue[]): FunctionResult;
    LN(number: ExcelValue): FunctionResult;
    LOG(number: ExcelValue, base?: ExcelValue): FunctionResult;
    LOG10(number: ExcelValue): FunctionResult;
    MDETERM(array: ExcelValue): FunctionResult;
    MINVERSE?(array: ExcelValue): FunctionResult;
    MMULT(array1: ExcelValue, array2: ExcelValue): FunctionResult;
    MOD(number: ExcelValue, divisor: ExcelValue): FunctionResult;
    MROUND(number: ExcelValue, multiple: ExcelValue): FunctionResult;
    MULTINOMIAL(...numbers: ExcelValue[]): FunctionResult;
    MUNIT(dimension: ExcelValue): FunctionResult;
    ODD(number: ExcelValue): FunctionResult;
    PI(): FunctionResult;
    POWER(number: ExcelValue, power: ExcelValue): FunctionResult;
    PRODUCT(...numbers: ExcelValue[]): FunctionResult;
    QUOTIENT(numerator: ExcelValue, denominator: ExcelValue): FunctionResult;
    RADIANS(angle: ExcelValue): FunctionResult;
    RAND(): FunctionResult;
    RANDBETWEEN(bottom: ExcelValue, top: ExcelValue): FunctionResult;
    ROMAN(number: ExcelValue, form?: ExcelValue): FunctionResult;
    ROUND(number: ExcelValue, numDigits: ExcelValue): FunctionResult;
    ROUNDDOWN(number: ExcelValue, numDigits: ExcelValue): FunctionResult;
    ROUNDUP(number: ExcelValue, numDigits: ExcelValue): FunctionResult;
    SERIESSUM(x: ExcelValue, n: ExcelValue, m: ExcelValue, coefficients: ExcelValue): FunctionResult;
    SIGN(number: ExcelValue): FunctionResult;
    SQRT(number: ExcelValue): FunctionResult;
    SQRTPI(number: ExcelValue): FunctionResult;
    SUBTOTAL(...args: ExcelValue[]): FunctionResult;
    SUM(...numbers: ExcelValue[]): FunctionResult;
    SUMIF(context: any, range: any, criteria: any, sumRange?: any): FunctionResult;
    SUMIFS(...args: ExcelValue[]): FunctionResult;
    SUMPRODUCT(array1: ExcelValue, ...arrays: ExcelValue[]): FunctionResult;
    SUMSQ(...numbers: ExcelValue[]): FunctionResult;
    SUMX2MY2(arrayX: ExcelValue, arrayY: ExcelValue): FunctionResult;
    SUMX2PY2(arrayX: ExcelValue, arrayY: ExcelValue): FunctionResult;
    SUMXMY2(arrayX: ExcelValue, arrayY: ExcelValue): FunctionResult;
    TRUNC(number: ExcelValue): FunctionResult;
    [key: string]: any;
}

// https://support.office.com/en-us/article/excel-functions-by-category-5f91f4e9-7b42-46d2-9bd1-63f26a86c0eb
const MathFunctions: MathFunctionCollection = {
    ABS: number => {
    ...
    'ISO.CEILING': (number, significance) => {
        return MathFunctions['CEILING.PRECISE'](number, significance);
    },
    ...
    SUMX2MY2: (arrayX, arrayY) => {
        const x: any[] = [], y: any[] = [];
        let sum = 0;
        H.flattenParams([arrayX], null, false, (item: any) => {
            x.push(item);
        });
        H.flattenParams([arrayY], null, false, (item: any) => {
            y.push(item);
        });
